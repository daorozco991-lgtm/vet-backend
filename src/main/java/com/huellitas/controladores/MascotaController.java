...
public class MascotaController {
    ...
    @PostMapping
    public ResponseEntity<MascotaDto> registrar(@Valid @RequestBody MascotaDto mascotaDto) {
    ...
    public ResponseEntity<MascotaDto> actualizar(@PathVariable Integer mascotaId, @Valid @RequestBody MascotaPatchDto mascotaPatchDto) {

        return ResponseEntity.ok(mascotaService.actualizar(mascotaId, mascotaPatchDto));
    }
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<MascotaDetailDto>> buscarPorNombreODueno(@RequestParam(name = "query", required = false, defaultValue = "") String busqueda, Pageable pageable) {

        return ResponseEntity.ok(mascotaService.buscarMascotaPorNombreODueno(busqueda, pageable));
    }

    @GetMapping("id/{mascotaId}")
    public ResponseEntity<MascotaDto> buscarPorId(@PathVariable Integer mascotaId) {
